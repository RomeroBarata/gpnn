...
activities = ['arranging_objects', 'picking_objects', 'taking_medicine', 'making_cereal', 'cleaning_objects',
              'stacking_objects', 'having_meal', 'microwaving_food', 'unstacking_objects', 'taking_food']
subactivities = ['reaching', 'moving', 'pouring', 'eating', 'drinking', 'opening', 'placing',
                 'closing', 'null', 'cleaning']
objects = ['medcinebox', 'cup', 'bowl', 'box', 'milk', 'book', 'microwave', 'plate', 'remote', 'cloth']
affordances = ['movable', 'stationary', 'reachable', 'pourable', 'pourto', 'containable',
